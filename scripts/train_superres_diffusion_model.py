...
parser.add_argument("-sl","--low_resolution", default= (128,128), nargs='+', type=int, help="Spatial resolution of the low resolution input condition")
parser.add_argument("-sh","--high_resolution", default= (640,640), nargs='+', type=int, help="Spatial resolution of the high resolution diffusion input.")
